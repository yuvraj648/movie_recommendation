...
# from C:\Users\Yuvraj\AppData\Roaming\Python\Python312\site-packages\fontTools\feaLib\lexer.cp312-win_amd64.pyd
# by generator 1.147
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import re as re # C:\Program Files\Python312\Lib\re\__init__.py
import os as os # C:\Program Files\Python312\Lib\os.py
...
class FeatureLibLocation(tuple):
    ...
    __orig_bases__ = (
        None, # (!) real value is '<function NamedTuple at 0x000002500A679E40>'
    )
    __slots__ = ()
...
class IncludingLexer(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'fontTools.feaLib.lexer\', \'__doc__\': "A Lexer that follows include statements.\\n\\n    The OpenType feature file specification states that due to\\n    historical reasons, relative imports should be resolved in this\\n    order:\\n\\n    1. If the source font is UFO format, then relative to the UFO\'s\\n       font directory\\n    2. relative to the top-level include file\\n    3. relative to the parent include file\\n\\n    We only support 1 (via includeDir) and 2.\\n    ", \'__init__\': <cyfunction IncludingLexer.__init__ at 0x000002500C4B1150>, \'__iter__\': <cyfunction IncludingLexer.__iter__ at 0x000002500C4B1220>, \'next\': <cyfunction IncludingLexer.next at 0x000002500C4B12F0>, \'__next__\': <cyfunction IncludingLexer.__next__ at 0x000002500C4B1490>, \'make_lexer_\': <staticmethod(<cyfunction IncludingLexer.make_lexer_ at 0x000002500C4B1560>)>, \'scan_anonymous_block\': <cyfunction IncludingLexer.scan_anonymous_block at 0x000002500C4B1630>, \'__dict__\': <attribute \'__dict__\' of \'IncludingLexer\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'IncludingLexer\' objects>})'
...
class Lexer(object):
    ...
    STRING = 'STRING'
    SYMBOL = 'SYMBOL'
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'fontTools.feaLib.lexer\', \'NUMBER\': \'NUMBER\', \'HEXADECIMAL\': \'HEXADECIMAL\', \'OCTAL\': \'OCTAL\', \'NUMBERS\': (\'NUMBER\', \'HEXADECIMAL\', \'OCTAL\'), \'FLOAT\': \'FLOAT\', \'STRING\': \'STRING\', \'NAME\': \'NAME\', \'FILENAME\': \'FILENAME\', \'GLYPHCLASS\': \'GLYPHCLASS\', \'CID\': \'CID\', \'SYMBOL\': \'SYMBOL\', \'COMMENT\': \'COMMENT\', \'NEWLINE\': \'NEWLINE\', \'ANONYMOUS_BLOCK\': \'ANONYMOUS_BLOCK\', \'CHAR_WHITESPACE_\': \' \\t\', \'CHAR_NEWLINE_\': \'\\r\\n\', \'CHAR_SYMBOL_\': ",;:-+\'{}[]<>()=", \'CHAR_DIGIT_\': \'0123456789\', \'CHAR_HEXDIGIT_\': \'0123456789ABCDEFabcdef\', \'CHAR_LETTER_\': \'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz\', \'CHAR_NAME_START_\': \'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz_+*:.^~!\\\\\', \'CHAR_NAME_CONTINUATION_\': \'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_.+*:^~!/-\', \'RE_GLYPHCLASS\': re.compile(\'^[A-Za-z_0-9.\\\\-]+$\'), \'MODE_NORMAL_\': \'NORMAL\', \'MODE_FILENAME_\': \'FILENAME\', \'__init__\': <cyfunction Lexer.__init__ at 0x000002500C4B0110>, \'__iter__\': <cyfunction Lexer.__iter__ at 0x000002500C4B0450>, \'next\': <cyfunction Lexer.next at 0x000002500C4B0BA0>, \'__next__\': <cyfunction Lexer.__next__ at 0x000002500C4B0C70>, \'location_\': <cyfunction Lexer.location_ at 0x000002500C4B0D40>, \'next_\': <cyfunction Lexer.next_ at 0x000002500C4B0E10>, \'scan_over_\': <cyfunction Lexer.scan_over_ at 0x000002500C4B0EE0>, \'scan_until_\': <cyfunction Lexer.scan_until_ at 0x000002500C4B0FB0>, \'scan_anonymous_block\': <cyfunction Lexer.scan_anonymous_block at 0x000002500C4B1080>, \'__dict__\': <attribute \'__dict__\' of \'Lexer\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Lexer\' objects>, \'__doc__\': None})'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002500A823140>'

__spec__ = None # (!) real value is "ModuleSpec(name='fontTools.feaLib.lexer', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002500A823140>, origin='C:\\\\Users\\\\Yuvraj\\\\AppData\\\\Roaming\\\\Python\\\\Python312\\\\site-packages\\\\fontTools\\\\feaLib\\\\lexer.cp312-win_amd64.pyd')"
