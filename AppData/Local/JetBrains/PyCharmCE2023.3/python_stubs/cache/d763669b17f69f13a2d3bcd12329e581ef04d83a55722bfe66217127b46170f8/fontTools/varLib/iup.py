...
# from C:\Users\Yuvraj\AppData\Roaming\Python\Python312\site-packages\fontTools\varLib\iup.cp312-win_amd64.pyd
# by generator 1.147
# no doc
...
class Real(__numbers.Complex):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x0000021A8ADD3440>'
    __abstractmethods__ = frozenset({'__pos__', '__trunc__', '__rpow__', '__floor__', '__mul__', '__lt__', '__rmul__', '__pow__', '__rmod__', '__ceil__', '__round__', '__rfloordiv__', '__add__', '__rtruediv__', '__float__', '__floordiv__', '__neg__', '__truediv__', '__le__', '__eq__', '__mod__', '__abs__', '__radd__'})
    __slots__ = ()
...
class Integral(__numbers.Rational):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x0000021A8ADD2EC0>'
    __abstractmethods__ = frozenset({'__pos__', '__lshift__', '__trunc__', '__rand__', '__rpow__', '__floor__', '__mul__', '__lt__', '__rlshift__', '__invert__', '__rmul__', '__ror__', '__pow__', '__rshift__', '__rmod__', '__rrshift__', '__ceil__', '__round__', '__rfloordiv__', '__and__', '__or__', '__int__', '__add__', '__rtruediv__', '__floordiv__', '__rxor__', '__neg__', '__truediv__', '__le__', '__eq__', '__mod__', '__abs__', '__xor__', '__radd__'})
    __slots__ = ()


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000021A8B154410>'

__spec__ = None # (!) real value is "ModuleSpec(name='fontTools.varLib.iup', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000021A8B154410>, origin='C:\\\\Users\\\\Yuvraj\\\\AppData\\\\Roaming\\\\Python\\\\Python312\\\\site-packages\\\\fontTools\\\\varLib\\\\iup.cp312-win_amd64.pyd')"
