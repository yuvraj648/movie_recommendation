...
def listdrives(*args, **kwargs): # real signature unknown
    """
...
def listmounts(*args, **kwargs): # real signature unknown
    """
...
def listvolumes(*args, **kwargs): # real signature unknown
    """
...
def _path_exists(*args, **kwargs): # real signature unknown
    """ Test whether a path exists.  Returns False for broken symbolic links """
    pass

def _path_isdevdrive(*args, **kwargs): # real signature unknown
    """ Determines whether the specified path is on a Windows Dev Drive. """
    pass

def _path_isdir(*args, **kwargs): # real signature unknown
    """ Return true if the pathname refers to an existing directory. """
    pass

def _path_isfile(*args, **kwargs): # real signature unknown
    """ Test whether a path is a regular file """
    pass

def _path_islink(*args, **kwargs): # real signature unknown
...
class DirEntry(object):
    ...
    def is_junction(self, *args, **kwargs): # real signature unknown
...
class stat_result(tuple):
    ...
    st_birthtime_ns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class __loader__(object):
    ...
    _ORIGIN = 'built-in'
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_frozen_importlib', '__doc__': 'Meta path import for built-in modules.\\n\\n    All methods are either class or static methods to avoid the need to\\n    instantiate the class.\\n\\n    ', '_ORIGIN': 'built-in', 'find_spec': <classmethod(<function BuiltinImporter.find_spec at 0x000001831D88EF20>)>, 'create_module': <staticmethod(<function BuiltinImporter.create_module at 0x000001831D88EFC0>)>, 'exec_module': <staticmethod(<function BuiltinImporter.exec_module at 0x000001831D88F060>)>, 'get_code': <classmethod(<function BuiltinImporter.get_code at 0x000001831D88F1A0>)>, 'get_source': <classmethod(<function BuiltinImporter.get_source at 0x000001831D88F2E0>)>, 'is_package': <classmethod(<function BuiltinImporter.is_package at 0x000001831D88F420>)>, 'load_module': <classmethod(<function _load_module_shim at 0x000001831D88E2A0>)>, '__dict__': <attribute '__dict__' of 'BuiltinImporter' objects>, '__weakref__': <attribute '__weakref__' of 'BuiltinImporter' objects>})"
