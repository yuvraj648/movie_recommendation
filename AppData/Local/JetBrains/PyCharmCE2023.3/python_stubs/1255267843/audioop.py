...
class __loader__(object):
    ...
    _ORIGIN = 'built-in'
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_frozen_importlib', '__doc__': 'Meta path import for built-in modules.\\n\\n    All methods are either class or static methods to avoid the need to\\n    instantiate the class.\\n\\n    ', '_ORIGIN': 'built-in', 'find_spec': <classmethod(<function BuiltinImporter.find_spec at 0x000001A225FCEF20>)>, 'create_module': <staticmethod(<function BuiltinImporter.create_module at 0x000001A225FCEFC0>)>, 'exec_module': <staticmethod(<function BuiltinImporter.exec_module at 0x000001A225FCF060>)>, 'get_code': <classmethod(<function BuiltinImporter.get_code at 0x000001A225FCF1A0>)>, 'get_source': <classmethod(<function BuiltinImporter.get_source at 0x000001A225FCF2E0>)>, 'is_package': <classmethod(<function BuiltinImporter.is_package at 0x000001A225FCF420>)>, 'load_module': <classmethod(<function _load_module_shim at 0x000001A225FCE2A0>)>, '__dict__': <attribute '__dict__' of 'BuiltinImporter' objects>, '__weakref__': <attribute '__weakref__' of 'BuiltinImporter' objects>})"
